...
//try
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control{{ $errors->has('middleName') ? ' is-invalid' : '' }}" name="middleName" value="{{ old('middleName') }}" required autofocus>
                        ...
                        <div class="form-group row required">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="date" class="form-control{{ $errors->has('birthdate') ? ' is-invalid' : '' }}" name="birthdate" value="{{ old('birthdate') }}" required autofocus>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" data-sitekey="6LfvxYoUAAAAALVH5SOoHXmqsETpH4DGXhKc7gyz"
                                        data-callback="YourOnSubmitFn" class="btn btn-primary g-recaptcha">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
